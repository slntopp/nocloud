...
// EnsureMDIIndex provides a mock function with given fields: ctx, fields, options
func (_m *MockCollection) EnsureMDIIndex(ctx context.Context, fields []string, options *driver.EnsureMDIIndexOptions) (driver.Index, bool, error) {
	ret := _m.Called(ctx, fields, options)

	if len(ret) == 0 {
		panic("no return value specified for EnsureMDIIndex")
	}

	var r0 driver.Index
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, *driver.EnsureMDIIndexOptions) (driver.Index, bool, error)); ok {
		return rf(ctx, fields, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, *driver.EnsureMDIIndexOptions) driver.Index); ok {
		r0 = rf(ctx, fields, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(driver.Index)
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, *driver.EnsureMDIIndexOptions) bool); ok {
		r1 = rf(ctx, fields, options)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(context.Context, []string, *driver.EnsureMDIIndexOptions) error); ok {
		r2 = rf(ctx, fields, options)
	} else {
		r2 = ret.Error(2)
	}
...
// MockCollection_EnsureMDIIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EnsureMDIIndex'
type MockCollection_EnsureMDIIndex_Call struct {
	*mock.Call
}

// EnsureMDIIndex is a helper method to define mock.On call
//   - ctx context.Context
//   - fields []string
//   - options *driver.EnsureMDIIndexOptions
func (_e *MockCollection_Expecter) EnsureMDIIndex(ctx interface{}, fields interface{}, options interface{}) *MockCollection_EnsureMDIIndex_Call {
	return &MockCollection_EnsureMDIIndex_Call{Call: _e.mock.On("EnsureMDIIndex", ctx, fields, options)}
}

func (_c *MockCollection_EnsureMDIIndex_Call) Run(run func(ctx context.Context, fields []string, options *driver.EnsureMDIIndexOptions)) *MockCollection_EnsureMDIIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].(*driver.EnsureMDIIndexOptions))
	})
	return _c
}

func (_c *MockCollection_EnsureMDIIndex_Call) Return(_a0 driver.Index, _a1 bool, _a2 error) *MockCollection_EnsureMDIIndex_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockCollection_EnsureMDIIndex_Call) RunAndReturn(run func(context.Context, []string, *driver.EnsureMDIIndexOptions) (driver.Index, bool, error)) *MockCollection_EnsureMDIIndex_Call {
	_c.Call.Return(run)
	return _c
}

// EnsureMDIPrefixedIndex provides a mock function with given fields: ctx, fields, options
func (_m *MockCollection) EnsureMDIPrefixedIndex(ctx context.Context, fields []string, options *driver.EnsureMDIPrefixedIndexOptions) (driver.Index, bool, error) {
	ret := _m.Called(ctx, fields, options)

	if len(ret) == 0 {
		panic("no return value specified for EnsureMDIPrefixedIndex")
	}

	var r0 driver.Index
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, *driver.EnsureMDIPrefixedIndexOptions) (driver.Index, bool, error)); ok {
		return rf(ctx, fields, options)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, *driver.EnsureMDIPrefixedIndexOptions) driver.Index); ok {
		r0 = rf(ctx, fields, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(driver.Index)
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, *driver.EnsureMDIPrefixedIndexOptions) bool); ok {
		r1 = rf(ctx, fields, options)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(context.Context, []string, *driver.EnsureMDIPrefixedIndexOptions) error); ok {
		r2 = rf(ctx, fields, options)
	} else {
		r2 = ret.Error(2)
	}
...
// MockCollection_EnsureMDIPrefixedIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EnsureMDIPrefixedIndex'
type MockCollection_EnsureMDIPrefixedIndex_Call struct {
	*mock.Call
}

// EnsureMDIPrefixedIndex is a helper method to define mock.On call
//   - ctx context.Context
//   - fields []string
//   - options *driver.EnsureMDIPrefixedIndexOptions
func (_e *MockCollection_Expecter) EnsureMDIPrefixedIndex(ctx interface{}, fields interface{}, options interface{}) *MockCollection_EnsureMDIPrefixedIndex_Call {
	return &MockCollection_EnsureMDIPrefixedIndex_Call{Call: _e.mock.On("EnsureMDIPrefixedIndex", ctx, fields, options)}
}

func (_c *MockCollection_EnsureMDIPrefixedIndex_Call) Run(run func(ctx context.Context, fields []string, options *driver.EnsureMDIPrefixedIndexOptions)) *MockCollection_EnsureMDIPrefixedIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]string), args[2].(*driver.EnsureMDIPrefixedIndexOptions))
	})
	return _c
}

func (_c *MockCollection_EnsureMDIPrefixedIndex_Call) Return(_a0 driver.Index, _a1 bool, _a2 error) *MockCollection_EnsureMDIPrefixedIndex_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockCollection_EnsureMDIPrefixedIndex_Call) RunAndReturn(run func(context.Context, []string, *driver.EnsureMDIPrefixedIndexOptions) (driver.Index, bool, error)) *MockCollection_EnsureMDIPrefixedIndex_Call {
	_c.Call.Return(run)
	return _c
}
