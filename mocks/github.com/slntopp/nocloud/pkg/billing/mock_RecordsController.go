...
func (_m *MockRecordsController) GetRecordsReports(ctx context.Context, req *billing.GetRecordsReportsRequest) (*billing.GetRecordsReportsResponse, error) {
	ret := _m.Called(ctx, req)
	...
	var r0 *billing.GetRecordsReportsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *billing.GetRecordsReportsRequest) (*billing.GetRecordsReportsResponse, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *billing.GetRecordsReportsRequest) *billing.GetRecordsReportsResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*billing.GetRecordsReportsResponse)
		}
	}
...
func (_c *MockRecordsController_GetRecordsReports_Call) Return(_a0 *billing.GetRecordsReportsResponse, _a1 error) *MockRecordsController_GetRecordsReports_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRecordsController_GetRecordsReports_Call) RunAndReturn(run func(context.Context, *billing.GetRecordsReportsRequest) (*billing.GetRecordsReportsResponse, error)) *MockRecordsController_GetRecordsReports_Call {
	_c.Call.Return(run)
	return _c
}
