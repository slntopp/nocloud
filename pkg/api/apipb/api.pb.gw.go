...
func request_ONeService_Token_0(ctx context.Context, marshaler runtime.Marshaler, client ONeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ONeService_Token_0(ctx context.Context, marshaler runtime.Marshaler, server ONeServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TokenRequest
	var metadata runtime.ServerMetadata
...
// RegisterONeServiceHandlerServer registers the http handlers for service ONeService to "mux".
// UnaryRPC     :call ONeServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterONeServiceHandlerFromEndpoint instead.
func RegisterONeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ONeServiceServer) error {

	mux.Handle("POST", pattern_ONeService_Token_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ONeService_Token_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ONeService_Token_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterONeServiceHandlerFromEndpoint is same as RegisterONeServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterONeServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterONeServiceHandler(ctx, mux, conn)
}

// RegisterONeServiceHandler registers the http handlers for service ONeService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterONeServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterONeServiceHandlerClient(ctx, mux, NewONeServiceClient(conn))
}

// RegisterONeServiceHandlerClient registers the http handlers for service ONeService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ONeServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ONeServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "ONeServiceClient" to call the correct interceptors.
func RegisterONeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ONeServiceClient) error {
	...
	mux.Handle("POST", pattern_ONeService_Token_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ONeService_Token_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ONeService_Token_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"token"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_ONeService_Token_0 = runtime.ForwardResponseMessage
)
