...
func (c *oNeServiceClient) Token(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, "/ione.api.ONeService/Token", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedONeServiceServer) Token(context.Context, *TokenRequest) (*TokenResponse, error) {
...
func _ONeService_Token_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ONeServiceServer).Token(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ione.api.ONeService/Token",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ONeServiceServer).Token(ctx, req.(*TokenRequest))
	}
...
var ONeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ione.api.ONeService",
	HandlerType: (*ONeServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Token",
			Handler:    _ONeService_Token_Handler,
		},
	},
