...
type DriverServiceClient interface {
	...
	MonitorStates(ctx context.Context, in *StateUpdateRequest, opts ...grpc.CallOption) (*GetTypeResponse, error)
}
...
func (c *driverServiceClient) MonitorStates(ctx context.Context, in *StateUpdateRequest, opts ...grpc.CallOption) (*GetTypeResponse, error) {
	out := new(GetTypeResponse)
	err := c.cc.Invoke(ctx, "/nocloud.instance.driver.vanilla.DriverService/MonitorStates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DriverServiceServer interface {
	...
	MonitorStates(context.Context, *StateUpdateRequest) (*GetTypeResponse, error)
...
func (UnimplementedDriverServiceServer) MonitorStates(context.Context, *StateUpdateRequest) (*GetTypeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MonitorStates not implemented")
}
...
func _DriverService_MonitorStates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StateUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DriverServiceServer).MonitorStates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nocloud.instance.driver.vanilla.DriverService/MonitorStates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).MonitorStates(ctx, req.(*StateUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DriverService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MonitorStates",
			Handler:    _DriverService_MonitorStates_Handler,
		},
	},
