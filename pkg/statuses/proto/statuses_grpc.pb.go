...
type PostServiceClient interface {
	...
	StateGet(ctx context.Context, in *proto.Service, opts ...grpc.CallOption) (*proto.GetStatesResponse, error)
}
...
func (c *postServiceClient) StateGet(ctx context.Context, in *proto.Service, opts ...grpc.CallOption) (*proto.GetStatesResponse, error) {
	out := new(proto.GetStatesResponse)
	err := c.cc.Invoke(ctx, "/nocloud.statuses.PostService/StateGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostServiceServer interface {
	...
	StateGet(context.Context, *proto.Service) (*proto.GetStatesResponse, error)
...
func (UnimplementedPostServiceServer) StateGet(context.Context, *proto.Service) (*proto.GetStatesResponse, error) {
...
func _PostService_StateGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(proto.Service)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostServiceServer).StateGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nocloud.statuses.PostService/StateGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).StateGet(ctx, req.(*proto.Service))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PostService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StateGet",
			Handler:    _PostService_StateGet_Handler,
		},
	},
