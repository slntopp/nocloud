...
type ServicesProvider struct {
	...
	Secrets map[string]*structpb.Value `protobuf:"bytes,2,rep,name=secrets,proto3" json:"secrets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // json
}
...
var file_pkg_services_providers_proto_services_providers_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xcf, 0x01, 0x0a, 0x10, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x50, 0x72,
	0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x12, 0x53, 0x0a, 0x07, 0x73, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x6e, 0x6f,
	...
	0x02, 0x38, 0x01, 0x42, 0xf6, 0x01, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x6f, 0x63, 0x6c,
...
var file_pkg_services_providers_proto_services_providers_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_services_providers_proto_services_providers_proto_goTypes = []interface{}{
	(*ServicesProvider)(nil), // 0: nocloud.services_providers.ServicesProvider
	nil,                      // 1: nocloud.services_providers.ServicesProvider.SecretsEntry
	(*structpb.Value)(nil),   // 2: google.protobuf.Value
}
var file_pkg_services_providers_proto_services_providers_proto_depIdxs = []int32{
	1, // 0: nocloud.services_providers.ServicesProvider.secrets:type_name -> nocloud.services_providers.ServicesProvider.SecretsEntry
	2, // 1: nocloud.services_providers.ServicesProvider.SecretsEntry.value:type_name -> google.protobuf.Value
