...
func (g *WhmcsGateway) syncWhmcsInvoice(ctx context.Context, invoiceId int) error {
	...
	var warning string
	if !synced {
		warning = "[WARNING]: THIS INVOICE ITEMS WERE UPDATED DIRECTLY FROM WHMCS. THIS MEANS THAT NOW THIS INVOICE DO NOT PROVIDE FUNCTIONALITY IN NOCLOUD! (DON'T UPDATE AUTOGENERATED AND FUNCTIONAL INVOICES THROUGH WHMCS)\n"
		inv.Items = newItems
