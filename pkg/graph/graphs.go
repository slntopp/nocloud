...
var COLLECTIONS = []string{ACCOUNTS_COL, NAMESPACES_COL, SERVICES_COL, INSTANCES_GROUPS_COL, INSTANCES_COL, CREDENTIALS_COL}
...
var SERVICES_GRAPH = NoCloudGraphSchema{
	Name: "Services",
	Edges: [][]string{
		{SERVICES_COL, INSTANCES_GROUPS_COL},
		{INSTANCES_GROUPS_COL, INSTANCES_COL},
	},
}
