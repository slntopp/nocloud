...
/**
 * Generated from protobuf message <code>nocloud.instance.driver.vanilla.InvokeRequest</code>
 */
class InvokeRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $method = '';
    /**
     * Generated from protobuf field <code>map<string, .google.protobuf.Value> params = 4 [json_name = "params"];</code>
     */
    private $params;
